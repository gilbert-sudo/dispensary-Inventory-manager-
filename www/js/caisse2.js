...
<button id="delbtn" onclick="deleteitem('ligne{{num3}}', 1, {{num1}});">✖</button>
<li><input type="text" name="name" value="{{name}}" disabled></li>
<li><input type="text" name="pu" value="{{pu}}" disabled></li>
<li><input type="text" name="qt" value="{{qt}}" disabled></li>
<li><input type="text"  id="p{{num2}}" name="total" value="{{total}}" disabled></li>
</ul>
`;
num = 0;
count = 1;
...
// function deleteCodefromCart(params) {
